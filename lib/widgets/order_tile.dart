...
import 'package:spiser_manager/widgets/order_header.dart';
...
class OrderTile extends StatelessWidget {
  ...
  final states = [
    "", "Na Fila", "Preparando", "Finalizando", "Entrega em Andamento", "Entrega Finalizada"
  ];
      ...
      child: Card(
        child: ExpansionTile(
          ...
          title: Text(
            ...
            style: TextStyle(color: order.data["status"] != 5 ? Colors.grey[850] : Colors.green),
          ),
          children: <Widget>[
            Padding(
